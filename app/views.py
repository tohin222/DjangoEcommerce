...
class ProductDetailView(View):
    def get(self,request,pk):
        ...
        if request.user.is_authenticated:
            item_already_in_cart = Cart.objects.filter(Q(product = product))
...
def orders(request):
    ...
    return render(request, 'app/orders.html',{'orders': od})
...
class CustomerRegistrationView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            messages.success(request,'Congrats!! you are regsiter')
            form.save()
        return render(request, 'app/customerregistration.html',{'form':form})
...
class ProfileView(View):
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            reg.save()
            messages.success(request,'congrats profile update')
        return render(request,'app/profile.html',{'form':form,'active':'btn-primary'})
